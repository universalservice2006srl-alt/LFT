...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue/60 focus-visible:ring-offset-2 focus-visible:ring-offset-cream",
      "disabled:cursor-not-allowed disabled:opacity-50",
      "data-[state=checked]:bg-blue data-[state=unchecked]:bg-navy/15",
      className
    )}
    {...props}
    ref={ref}
