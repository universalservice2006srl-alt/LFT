...
export function VehiclePicker({
  ...
  onSelect: (v: VehicleOption | null) => void;
}) {
        ...
        <div className="max-h-72 overflow-y-auto p-1.5">
          <button
            ...
            className={cn(
              ...
              !selected ? "bg-blue/8" : "hover:bg-cream"
            )}
          >
            <span className="min-w-0 flex-1">
              <span className="block text-sm font-semibold text-navy">Leave blank / no assigned vehicle</span>
              <span className="mt-0.5 block text-xs text-ink-soft">Use any available fleet vehicle later or keep this empty.</span>
            </span>
          </button>
